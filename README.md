...
- AI-assisted scripting with Codex, Claude Code, Pi Code, opencode, Copilot CLI, and MCP workflows
...
- BreakTest can run AI-assisted script repair from the GUI or through local
  agent tooling.
- The agent workflow works with tools such as Codex, Claude Code, Pi Code, opencode, and Copilot CLI
