...
public object BreakTestAgentMcpServer {
     ...
     * Codex-specific: Codex, Claude Code, Gemini CLI, Pi Code, opencode and
     * Copilot CLI all reach it through the same stdio bridge, so labelling it
     * "Codex MCP" mislabels the other harnesses.
     */
