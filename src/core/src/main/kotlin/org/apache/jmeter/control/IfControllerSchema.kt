...
public abstract class IfControllerSchema : GenericControllerSchema() {
    public companion object INSTANCE : IfControllerSchema()

    public val condition: StringPropertyDescriptor<IfControllerSchema>
        by string("IfController.condition")

    public val evaluateAll: BooleanPropertyDescriptor<IfControllerSchema>
        by boolean("IfController.evaluateAll", default = false)
