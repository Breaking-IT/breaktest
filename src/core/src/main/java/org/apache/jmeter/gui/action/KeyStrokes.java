...
public final class KeyStrokes {
    ...
    public static final KeyStroke REDO              = KeyStroke.getKeyStroke(KeyEvent.VK_Z, CONTROL_MASK | InputEvent.SHIFT_DOWN_MASK);
    public static final KeyStroke UNDO_CONTROL      = KeyStroke.getKeyStroke(KeyEvent.VK_Z, InputEvent.CTRL_DOWN_MASK);
