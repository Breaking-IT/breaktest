# Launching BreakTest from Eclipse

You can use the Gradle task `runGui` to run the BreakTest GUI, or you can follow the instructions
...
Note: you can use Gradle task `runGui` to start BreakTest, however Eclipse does not support
...
1. On the arguments tab use the following for `Working Directory`: `${workspace_loc:breaktest/bin}`
